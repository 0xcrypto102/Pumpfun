...
pub fn withdraw(ctx: Context<Withdraw>) -> Result<()> {
    ...
    require!(accts.bonding_curve.complete == true, ApeLolCode::BondingCurveNotComplete);
    require!(accts.global.owner_wallet == accts.owner_wallet.key(), ApeLolCode::NotAuthorized);
